...
<h2 align="center">
예약부터 현장 체크인, 방문 기록 축적까지 이어지는 지역 참여형 스탬프·리워드 플랫폼
</h2>
...
> 개발 기간: 2026.07.21 - 2026.08.24 (4인)

로컬스탬프는 지역 행사와 체험을 탐색하고 예약한 뒤,
현장에서 QR로 체크인해 방문 기록을 쌓고 스탬프와 미션 혜택으로 이어갈 수 있는 서비스입니다.
...
- 지역을 선택하면 해당 지역의 행사와 체험만 볼 수 있습니다.
- 남은 자리와 예약 가능 여부는 최신 상태로 표시되어 마감된 행사가 "예약 가능"으로 보이지 않습니다.
...
- 비밀 값은 저장소에 기록하지 않고 환경 변수와 비밀 관리 수단으로 주입합니다.
